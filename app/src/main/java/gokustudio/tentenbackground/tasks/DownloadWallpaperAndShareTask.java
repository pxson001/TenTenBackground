 ...
 */
public class DownloadWallpaperAndShareTask extends AsyncTask<String, Integer, String>{

    private MaterialDialog progressDialog;
    private Context context;
    private DownloadedWallpaperListener downloadedWallpaperListener;

    public DownloadWallpaperAndShareTask(Context context, DownloadedWallpaperListener listener){
    ...
    protected void onPostExecute(String wallpaperPath) {
        ...
        Utils.shareImage(context, wallpaperPath);
    }
}
